...
class ERL_Trainer:
	...
	def forward_generation(self, gen, tracker):
		...
		return all_fitness,gen_max, champ_len, all_eplens, test_mean, test_std, rollout_fitness, rollout_eplens
	...
	def train(self, gen,test_tracker):
		...
		time_start = time.time()
		  ...
		  # Infinite generations
			...
			# Train one iteration
		all_fitness,max_fitness, champ_len, all_eplens, test_mean, test_std, rollout_fitness, rollout_eplens = self.forward_generation(gen, test_tracker)
		...
		for i in range(len(self.population)) :
			...
			self.population[i]._belong =  task_index
            
			print(self.population[i]._belong)
               '''
